...
RSpec.describe Product, type: :model do
  ...
  it "is created and belongs to a category" do
    ...
    expect(product.description).to eq("The gold standard of carnivorous plants!")
    ...
    expect(product.category.description).to eq("The largest carnivorous plant selection in the world!")
  end
